...
export default function Home() {
  ...
  return <main>
    ...
    <section id="contact" className="contact section-shell" aria-labelledby="contact-title"><div className="contact-main reveal"><p className="eyebrow">CONTACT</p><h2 id="contact-title">Let&apos;s work on<br />something useful.</h2><p>For analytics, data, AI, and quantitative opportunities, I&apos;d be glad to connect.</p></div><address className="contact-links reveal"><a href="mailto:EMAIL@REPLACE.ME"><span>Email</span><strong>[EMAIL PLACEHOLDER]</strong><Arrow /></a><a href="https://www.linkedin.com/in/LINKEDIN-PLACEHOLDER" target="_blank" rel="noreferrer"><span>LinkedIn</span><strong>[LINKEDIN PLACEHOLDER]</strong><Arrow /></a><a href="https://github.com/GITHUB-PLACEHOLDER" target="_blank" rel="noreferrer"><span>GitHub</span><strong>[GITHUB PLACEHOLDER]</strong><Arrow /></a><p><span>Location</span><strong>Dallas, Texas</strong></p></address></section>
